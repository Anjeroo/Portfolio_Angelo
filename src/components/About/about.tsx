    ...
    return(
        <div id="aboutDiv">
            ...
            <div id="experience">
              ...
              <div className="works">
                <h2 className="workTitle"><img src="/src/assets/fernandes.jpg" className="workIcon" />Fernandes | Atualmente</h2>
                <h3 className="function">Repositor de Mercadorias</h3>
              </div>
              <div className="works">
                <h2 className="workTitle"><img src="/src/assets/confianca.png" className="workIcon" />Confiança | 6 meses</h2>
